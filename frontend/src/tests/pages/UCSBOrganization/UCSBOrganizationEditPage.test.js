...
describe("UCSBOrganizationEditPage tests", () => {
    ...
    describe("tests where backend is working normally", () => {
        ...
        test("Is populated with the data provided", async () => {
            ...
            fireEvent.change(orgTranslationShortField, { target: { value: 'ZETA PHI RHO FRAT' } });
            fireEvent.change(orgTranslationField, { target: { value: 'ZETA PHI RHO FRATERNITY' } });
            fireEvent.change(inactiveField, { target: { value: 'false' } });
            fireEvent.click(submitButton);

            await waitFor(() => expect(mockToast).toBeCalled());
            expect(mockToast).toBeCalledWith("UCSBOrganization Updated - orgCode: ZPR orgTranslationShort: ZETA PHI RHO FRAT orgTranslation: ZETA PHI RHO FRATERNITY inactive: false");
