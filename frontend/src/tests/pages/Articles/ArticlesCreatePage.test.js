...
describe("ArticlesCreatePage tests", () => {
    ...
    test("on submit, makes request to backend, and redirects to /articles", async () => {
        ...
        fireEvent.change(titleInput, { target: { value: "article 23" } })
        fireEvent.change(urlInput, { target: { value: "article 3 url" } })
        fireEvent.change(explanationInput, { target: { value: "article 3 explanation" } })
        fireEvent.change(emailInput, { target: { value: "article3@yahoo.com" } })
        ...
        expect(mockToast).toBeCalledWith("New articles Created - id: 3 title: article 23");
