...
describe("HelpRequestCreatePage tests", () => {
    ...
    test("on submit, makes request to backend, and redirects to /helprequest", async () => {
        ...
        fireEvent.change(requesterEmailInput, { target: { value: 'kavyaverma@ucsb.edu' } })
        fireEvent.change(teamIdInput, { target: { value: 'w24-7pm-2' } })
        fireEvent.change(tableOrBreakoutRoomInput, { target: { value: '7' } })
        fireEvent.change(requestTimeInput, { target: { value: '2024-02-05T00:00:00' } })
        ...
        expect(axiosMock.history.post[0].params).toEqual({
            ...
            teamId: "w24-7pm-2",
            tableOrBreakoutRoom: "7",
            requestTime: "2024-02-05T00:00",
            explanation: "Need help with Swagger-ui",
            solved: false
        });

        // assert - check that the toast was called with the expected message
        expect(mockToast).toBeCalledWith("New Help Request Created - id: 1 requesterEmail: kavyaverma@ucsb.edu teamId: w24-7pm-2 tableOrBreakoutRoom: 7 requestTime: 2024-02-05T00:00:00 explanation: Need help with Swagger-ui solved: false");
