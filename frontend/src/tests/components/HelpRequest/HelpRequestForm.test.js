...
describe("HelpRequestForm tests", () => {
    ...
    test("No Error messsages on good input", async () => {
        ...
        fireEvent.change(requesterEmailField, { target: { value: 'kavyaverma@ucsb.edu' } });
        fireEvent.change(teamIdField, { target: { value: 'w24-7pm-2' } });
        fireEvent.change(tableOrBreakoutRoomField, { target: { value: '14' } });
        fireEvent.change(requestTimeField, { target: { value: '2024-02-14T03:00' } });
        fireEvent.change(explanationField, { target: { value: 'dokku error' } });
